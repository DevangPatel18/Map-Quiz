const alpha3Codes = {
  ...
  south: ["ARG", "BOL", "BRA", "CHL", "COL", "ECU", "GUY", "PER", "PRY", "SUR", "URY", "VEN", "GUF"],
  carrib: ["ABW", "AIA", "ATG", "BHS", "BLM", "BRB", "CUB", "CUW", "CYM", "DMA", "DOM", "GRD", "HTI", "JAM", "KNA", "LCA", "MAF", "MSR", "PRI", "SXM", "TCA", "TTO", "VCT", "VGB", "VIR", "GLP", "MTQ", "BES"],
  ...
  oceania: ["ASM", "AUS", "FJI", "FSM", "GUM", "KIR", "MHL", "MNP", "NCL", "NFK", "NRU", "NZL", "PLW", "PNG", "SLB", "TON", "VUT", "WLF", "WSM", "COK", "PYF", "PCN", "NIU"]
}
